#!/usr/bin/env python3
"""
Prebuilt patch apply for the anthropic.claude-code VS Code extension 2.1.122.

Patches A through G applied as literal string replacements verified
byte-stable against the 2.1.122 bundle. Synthesized by
...
Default: auto-discovers an installed 2.1.122 extension under
