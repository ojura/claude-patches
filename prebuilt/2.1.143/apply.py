#!/usr/bin/env python3
"""
Prebuilt patch apply for the anthropic.claude-code VS Code extension 2.1.143.

Patches A through K applied as literal string replacements verified
byte-stable against the 2.1.143 bundle. Synthesized by
...
Default: auto-discovers an installed 2.1.143 extension under
