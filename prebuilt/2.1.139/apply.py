#!/usr/bin/env python3
"""
Prebuilt patch apply for the anthropic.claude-code VS Code extension 2.1.139.

Patches A through K applied as literal string replacements verified
byte-stable against the 2.1.139 bundle. Synthesized by
...
Default: auto-discovers an installed 2.1.139 extension under
...
/*pfg-v1.6*/ signature in extension.js). With --force, restores from .bak files
and re-applies.
"""
import glob
import os
