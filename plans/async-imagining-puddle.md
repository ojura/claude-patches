...
> **Baseline note.** This plan was drafted against the v1.7 patchset, and its implementation citations point at the v1.7 prebuilts. Those now live under `prebuilt/archive/v1.7/` (2.1.142, 2.1.143, 2.1.145, 2.1.146) and `prebuilt/archive/broken/v1.7/2.1.148/` (2.1.148, the newest v1.7 build, since archived as known-broken). The archived files are unchanged, so each `prebuilt/2.1.148/apply.py:NN` citation below resolves at the same line numbers under `prebuilt/archive/broken/v1.7/2.1.148/apply.py`. Current shipped patchset: v1.8.
